...
using Content.Server._Misfits.Holotape; // #Misfits Add - Supporter manager
...
namespace Content.Server.Entry
{
    public sealed class EntryPoint : GameServer
    {
        ...
        [Dependency] private readonly TerminalNotesDataStore _terminalNotesData = default!; // #Misfits Add
        // [Dependency] private readonly TerminalNotesDataStore _terminalNotesData = default!; // #Misfits Add
        [Dependency] private readonly TerminalDatabaseDataStore _dbTerminalData = default!; // #Misfits Add
        ...
        public override void Init()
        {
            ...
            */
            ...
            _terminalNotesData.Initialize();
            _dbTerminalData.Initialize();
            _job.Initialize();
            _rateLimit.Initialize();
            _sponsorManager.Initialize();
            _supporterManager.Initialize();
        }
